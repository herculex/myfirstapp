...
public class MySwipes extends Activity {

    private SwipeLayout sample1,sample2,sample3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_swipes);
        ...
        sample1.getSurfaceView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MySwipes.this, "Click on surface", Toast.LENGTH_SHORT).show();
        ...
        sample1.getSurfaceView().setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(MySwipes.this, "longClick on surface", Toast.LENGTH_SHORT).show();
        ...
        sample1.findViewById(R.id.star2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MySwipes.this, "Star", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        sample1.findViewById(R.id.trash2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MySwipes.this, "Trash Bin", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        sample1.findViewById(R.id.magnifier2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MySwipes.this, "Magnifier", Toast.LENGTH_SHORT).show();
            }
        });
...
//        sample2.setShowMode(SwipeLayout.ShowMode.PullOut);
        ...
        sample2.findViewById(R.id.click).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MySwipes.this, "Yo", Toast.LENGTH_SHORT).show();
            }
        });
